...
form.addEventListener('submit', function (e) {
  ...
  if (isNaN(value) || value <= 0) {
    ...
    for (let i = 0; i < value; i++) {
      ...
      } while (tempIndex == random);
      tempText += `<p class='result'>${text[random]}</p>`;
      tempIndex = random;
    }
  }
...
// normal solution here

// form.addEventListener('submit', function (e) {
//   e.preventDefault(); // <--- normally submits to a server, this avoids that
//   let value = amount.value;
//   // console.log(typeof value); // <--- oh no, its a string, how could we fix this?!??!?!?!
